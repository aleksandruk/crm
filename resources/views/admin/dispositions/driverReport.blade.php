    ...
    <div class="panel panel-default">
        ...
        <div>
            <form class="form-horizontal" role="form" method="post" action="{{action('Admin\DispositionsController@driverReportUpdate', 'id='.$disposition->id)}}">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="report">Деталі відправки:</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" id="report" name="report" cols="40" rows="5">{{$disposition->report}}</textarea>
                ...
                <div class="form-group">
                  ...
                  <a href="{{ route('admin.dispositions.my_parcels') }}" class="btn btn-danger">Відмінити</a>
                </div>
            </form>
        </div>
    </div>
