...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div>
            <form class="form-horizontal" role="form" method="post" action="{{action('Admin\DispositionsController@update', $disposition->id)}}">
                ...
                <div class="form-group">
                  ...
                  <a href="{{ route('admin.dispositions.index') }}" class="btn btn-danger">Відмінити</a>
                </div>
            </form>
        </div>
    </div>
